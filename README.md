...
load will simulate on 3 slaves each running 500 users. Each user will be hitting the main page of the blog and searching a keyword right after that to find matching blogs.
